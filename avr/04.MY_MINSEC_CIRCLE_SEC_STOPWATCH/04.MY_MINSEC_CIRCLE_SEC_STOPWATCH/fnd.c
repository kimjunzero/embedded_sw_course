...
{
    int operand_index2[] = { ~0, ~1, ~1, ~1, ~1 ,~1 ,~0x09 ,~0x0D ,~0x0F, ~0, ~2, ~6, ~14 , ~14, ~14, ~14, ~14, ~15 }; // 3번째 fnd
    int operand_index3[] = { ~0, ~0, ~1, ~0b00100001, ~0b00110001, ~0b00111001, ~0b00111001, ~0b00111001, ~0b00111001, ~0, ~0, ~0, ~0, ~8,  ~0b00011000, ~0b00111000, ~0b00111001, ~0b00111001 }; // 4번째 fnd
